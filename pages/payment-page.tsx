...
export default function PaymentPage() {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            const result = await axios.post('https://f5de3952-d14f-42a1-b1cb-226f2bdbc10f.mock.pstmn.io/c_user', {});
            setUserData(result.data);
            console.log(result.data)
        };

        const fetchProductData = async () => {
            const response = await axios.post('https://f5de3952-d14f-42a1-b1cb-226f2bdbc10f.mock.pstmn.io/product_trans');
